...
class Ui_Dialog_XuatBieuNhom2(object):
    def setupUi(self, Dialog_XuatBieuNhom2):
        ...
        self.btn_ok.setGeometry(QtCore.QRect(350, 250, 75, 23))
        self.btn_ok.setObjectName("btn_ok")
        self.btn_cancel = QtWidgets.QPushButton(Dialog_XuatBieuNhom2)
        self.btn_cancel.setGeometry(QtCore.QRect(440, 250, 75, 23))
        ...
        self.lbl_ketqua.setGeometry(QtCore.QRect(20, 190, 161, 16))
        self.lbl_ketqua.setObjectName("lbl_ketqua")
        self.layoutWidget = QtWidgets.QWidget(Dialog_XuatBieuNhom2)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 210, 491, 24))
        ...
        self.groupBox = QtWidgets.QGroupBox(Dialog_XuatBieuNhom2)
        self.groupBox.setGeometry(QtCore.QRect(20, 90, 191, 80))
    ...
    def retranslateUi(self, Dialog_XuatBieuNhom2):
        ...
        self.groupBox.setTitle(_translate("Dialog_XuatBieuNhom2", "Kiểu xuất biểu"))
        self.rBtn_156.setText(_translate("Dialog_XuatBieuNhom2", "Mẫu biểu theo nghị định 156"))
        self.rBtn_HB.setText(_translate("Dialog_XuatBieuNhom2", "Mẫu biểu của Quỹ Hòa Bình"))
