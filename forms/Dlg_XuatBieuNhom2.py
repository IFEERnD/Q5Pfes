...
class Ui_Dialog_XuatBieuNhom2(object):
    def setupUi(self, Dialog_XuatBieuNhom2):
        ...
        Dialog_XuatBieuNhom2.resize(531, 262)
        ...
        self.btn_ok.setGeometry(QtCore.QRect(350, 200, 75, 23))
        self.btn_ok.setObjectName("btn_ok")
        self.btn_cancel = QtWidgets.QPushButton(Dialog_XuatBieuNhom2)
        self.btn_cancel.setGeometry(QtCore.QRect(440, 200, 75, 23))
        ...
        self.lbl_churung2 = QtWidgets.QLabel(Dialog_XuatBieuNhom2)
        self.lbl_churung2.setGeometry(QtCore.QRect(213, 30, 71, 16))
        self.lbl_churung2.setObjectName("lbl_churung2")
        self.lbl_ketqua = QtWidgets.QLabel(Dialog_XuatBieuNhom2)
        self.lbl_ketqua.setGeometry(QtCore.QRect(20, 130, 161, 16))
        self.lbl_ketqua.setObjectName("lbl_ketqua")
        self.layoutWidget = QtWidgets.QWidget(Dialog_XuatBieuNhom2)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 150, 491, 24))
    ...
    def retranslateUi(self, Dialog_XuatBieuNhom2):
        ...
        self.lbl_churung2.setText(_translate("Dialog_XuatBieuNhom2", "Chủ rừng"))
